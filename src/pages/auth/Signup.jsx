...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F7FAFC] flex items-center justify-center px-3 sm:px-4 md:px-6 py-6">
            <div className="relative w-full max-w-[450px] bg-white border border-[#DEE2E7] rounded-xl shadow-md p-4 sm:p-6 md:p-8">
                ...
                <div className="flex items-center justify-center gap-2 mb-3">
                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.8">
                            <path fillRule="evenodd" clipRule="evenodd" d="M14.4673 1.91309H37.1847C40.9486 1.91309 43.9999 5.28555 43.9999 9.44569V34.5544C43.9999 38.7145 40.9486 42.087 37.1847 42.087H14.4673C10.7034 42.087 7.6521 38.7145 7.6521 34.5544L7.6521 9.44569C7.6521 5.28555 10.7034 1.91309 14.4673 1.91309Z" fill="#0D6EFD" fill-opacity="0.2" />
                ...
                {/* Heading */}
                <h2 className="text-[22px] sm:text-[24px] md:text-[28px] font-semibold text-gray-800 text-center">
                    Create account
                </h2>

                <p className="text-[13px] sm:text-[14px] md:text-[15px] text-gray-500 text-center mb-3">
                ...
                {
                    error && (
                        <div className="text-red-600 mb-4 text-center text-[13px] sm:text-[14px]">
                            {error}
                        </div>
                    )
                }
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                    ...
                    {/* Name */}
                    <div>
                        <label className="block text-[14px] sm:text-[15px] md:text-[16px] text-gray-700 mb-1">Name</label>
                        <input
                            type="text"
                            name="name"
                            value={formData.name}
                            ...
                            className="w-full border border-[#DEE2E7] rounded-lg px-3 sm:px-4 py-2.5 md:py-3 text-[14px] sm:text-[15px] md:text-[16px] focus:outline-none focus:border-blue-500"
                            required
                        />
                    </div>
                    ...
                    {/* Email */}
                    <div>
                        <label className="block text-[14px] sm:text-[15px] md:text-[16px] text-gray-700 mb-1">Email</label>
                        <input
                            type="email"
                            name="email"
                    ...
                    {/* Password */}
                    <div>
                        <label className="block text-[14px] sm:text-[15px] md:text-[16px] text-gray-700 mb-1">
                            Password
                        </label>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full border border-[#DEE2E7] rounded-lg px-3 sm:px-4 py-2.5 md:py-3 pr-12 text-[14px] sm:text-[15px] md:text-[16px] focus:outline-none focus:border-blue-500"
                                required
                            />
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-500 hover:bg-blue-600 text-white text-[14px] sm:text-[15px] md:text-[16px] font-medium py-2.5 md:py-3 rounded-lg transition disabled:opacity-50"
                    >
